 ...
 * @return zwaraca wartosc typu void, czyli nic. Mamy tylko std::cout (wypisywanie tego,  co podalismy jako argument)
*/
 ...
 * @return zwaraca void, czyli nic. Mamy tylko std::cout (wypisywanie tego,  co podalismy jako argument)
*/
